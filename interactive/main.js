...
loader.load(
  'https://assets.nihaalnazeer.com/models/roomv8.glb',
  (gltf) => {
    // these are the mesh names in your GLTF you want to drive with video:
    const screenNames = ['news1','news2','news3','wallpaper'];
    const videoFiles  = {
      news1:     'https://assets.nihaalnazeer.com/backgroundvideos/news1loop.mp4',
      news2:     'https://assets.nihaalnazeer.com/backgroundvideos/news2loop.mp4',
      news3:     'https://assets.nihaalnazeer.com/backgroundvideos/news3loop.mp4',
      wallpaper: 'https://assets.nihaalnazeer.com/backgroundvideos/wallpaperloop.mp4',
    };
...
loader.load(
  ...
  (gltf) => {
    ...
    const lightningSound = new Audio('https://assets.nihaalnazeer.com/videos/shootsound.mp3');
    lightningSound.loop = true;
    let wasLightningActive = false;

    // Create audio for walking
    const walkingSound = new Audio('https://assets.nihaalnazeer.com/videos/walkingsound.mp3');
    ...
    sitImage.src = 'https://assets.nihaalnazeer.com/buttonoverlays/sit.png';
    ...
    exitVideo.src = 'https://assets.nihaalnazeer.com/videos/exitvideo.mp4';
    ...
    exitVideo.addEventListener('ended', () => {
        // Create exit message overlay with reset button and close instructions
        ...
        exitMessage.innerHTML = `
            <div style="max-width: 500px; padding: 40px;">
                ...
                <div style="border-top: 1px solid rgba(255,255,255,0.2); padding-top: 30px;">
                    <p style="margin-bottom: 15px; font-size: 16px; opacity: 0.8;">Or close this tab to exit:</p>
                    <p style="font-size: 14px; opacity: 0.6;">
                        Press <strong>Ctrl+W</strong> (or <strong>Cmd+W</strong> on Mac)
                    </p>
                </div>
            </div>
        `;
    ...
    portfolioButtons.forEach(btn => {
        ...
        img.src = `https://assets.nihaalnazeer.com/buttonoverlays/${btn.name}.png`;
    ...
    const InteractionManager = (() => {
        ...
        function play(src, onEnded) {
            video.src = `https://assets.nihaalnazeer.com/interactiveanimations/${src}`;
        ...
        function showChoiceFreeze() {
            ...
            video.src = "https://assets.nihaalnazeer.com/interactiveanimations/choice.mp4";
            video.style.display = "block";
            video.play().then(() => {
        ...
        function getOverlayHTML(state) {
            switch (state) {
                case State.Choice:
                    return `
                        <img src="https://assets.nihaalnazeer.com/buttonoverlays/viewresume.png" class="choice-btn left" />
                        <img src="https://assets.nihaalnazeer.com/buttonoverlays/stand.png"      class="choice-btn center" />
                        <img src="https://assets.nihaalnazeer.com/buttonoverlays/viewportfolio.png" class="choice-btn right" />
                    `;
                case State.Resume:
                    return `<img src="https://assets.nihaalnazeer.com/buttonoverlays/putdownresume.png" class="resume-btn bottom-left" />`;
            ...
            switch (newState) {
                ...
                case State.Portfolio:
                    play("viewportfolio.mp4", () => {
                        ...
                        portfolioImage.src = `https://assets.nihaalnazeer.com/interactiveimages/${portfolioItems[0].image}`;
            ...
            if (currentState === State.Choice) {
                ...
                switch (e.key.toLowerCase()) {
                    case 'a': // previous
                        ...
                        portfolioImage.src = `https://assets.nihaalnazeer.com/interactiveimages/${portfolioItems[currentPortfolioIndex].image}`;
                        break;
                    case 'd': // next
